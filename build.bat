...
call cl /DWIN32_LEAN_AND_MEAN /DNDEBUG /DUNICODE /std:c++17 /DIMGUI_USE_STB_SPRINTF /O2 /EHsc /nologo /Iinclude /Iimgui /Iimgui/backends freedom/*.cpp imgui/*.cpp imgui/backends/*.cpp /link /DLL /MACHINE:x86 /OUT:freedom.dll
