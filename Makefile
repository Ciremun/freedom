...
FREEDOM_CXXFLAGS = -DWIN32_LEAN_AND_MEAN -DUNICODE -std:c++17 -DIMGUI_USE_STB_SPRINTF -DIMGUI_DEFINE_MATH_OPERATORS -Z7 -Od -MDd -EHsc -nologo -Iinclude -Iimgui -Iimgui/backends
